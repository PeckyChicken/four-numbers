...
mode = ""
while mode not in ("1","2","levels","level","leveled","random","l","r"):
    mode = input("Leveled mode (1) or random mode (2)?\n> ")
    mode = mode.strip()

if "level" in mode or mode in ("1","l"):
    mode = "leveled"
else:
    mode = "random"

help_text = f'''The aim of the game is to combine the numbers you have using the 4 classic mathematical operations (addition +, subtraction -, multiplication * and division /) to reach your target.
...
If a puzzle is too hard for you AND you are in random mode, you can type "skip" or "new" and it will be replaced. You are currently in {mode} mode.
